...
class Robot(RadioDevice):
    ...
    # the nonce being incremented is for the hash, not encryption
    # encryption generates a random nonce always
    ...
    async def run(self):
        #this entire loop can run MULTIPLE TIMES!
        while self.running:
            ...
            self.send_message({
                ...
                "dst": ROBOT_ADDRESS,
                "msg_type": "validate",
                "challenge": challenge #this is plaintext
            })
